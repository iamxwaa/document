...
- findbugs和pmd可以在开发人员编写代码时使用，当开发人员写完一个功能后可以使用这两个组件做一遍静态检查，处理掉一些简单的bug，处理完毕后再提交代码；

- checkstyle可以在开发和构建打包的使用，主要用来检查开发人员编写的代码是否合乎规范，不规范的代码是无法通过编译的；（该插件可以后续引入）

- junit可以在功能开发完成后由开发人员编写相应的测试代码（某些功能的测试代码可能需要一些mock框架支持），用来测试代码的基本逻辑是否能够运行。


### 使用说明

### [FindBugs](https://baike.baidu.com/item/FindBugs/4111190)

参考链接 [https://baike.baidu.com/item/FindBugs/4111190](https://baike.baidu.com/item/FindBugs/4111190)

FindBugs 是由马里兰大学提供的一款开源 Java静态代码分析工具。FindBugs通过检查类文件或 JAR文件，将字节码与一组缺陷模式进行对比从而发现代码缺陷，完成静态代码分析。FindBugs提供eclipse 和 idea插件直接调用。

![findbugs1](qa/f1.png)

直接点击提示可以跳转到错误代码处。
图中的错误提示，可以使用Stringbuffer代替字符串“+”拼接可以提高效率。

### [PMD](https://blog.csdn.net/u011781521/article/details/78834031)

参考链接 [https://blog.csdn.net/u011781521/article/details/78834031](https://blog.csdn.net/u011781521/article/details/78834031)

PMD是一款采用BSD协议发布的Java程序代码检查工具。该工具可以做到检查Java代码中是否含有未使用的变量、是否含有空的抓取块、是否含有不必要的对象等。
...
图中的错误提示，因为“UTF-8”这个字符串出现多次，可以考虑提取为公共常量。

### [Checkstyle](https://blog.csdn.net/cl_andywin/article/details/79948215)

参考链接 
- [https://blog.csdn.net/cl_andywin/article/details/79948215](https://blog.csdn.net/cl_andywin/article/details/79948215)
...
Checkstyle可以自定义一些代码规范用于在编译中强制执行。CheckStyle默认使用的是Sun的编码规范。
...
## [Junit](https://baike.baidu.com/item/JUnit)

参考链接 [https://baike.baidu.com/item/JUnit](https://baike.baidu.com/item/JUnit)
...
覆盖率窗口可以看到提供测试用例的类、测试的方法个数、测试代码所覆盖的代码行数。
